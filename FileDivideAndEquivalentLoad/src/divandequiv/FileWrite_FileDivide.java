...
public class FileWrite_FileDivide {
	
	private ArrayList<String> inputList;
	private PrintWriter out;
	private boolean bool;
	
	public FileWrite_FileDivide(ArrayList<String> name, ArrayList<String> list, String dir) throws Exception {
		/*
		System.out.println("\n------------------------------");
	...
	private ArrayList<String> calcAverage() {
